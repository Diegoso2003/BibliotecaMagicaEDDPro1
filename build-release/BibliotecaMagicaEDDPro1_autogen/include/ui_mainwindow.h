...
public:
    ...
    QAction *actionGrafico_arbol_B_ordenado_por_a_o;
    QAction *actionGrafico_arbol_B_ordenado_por_genero;
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        actionGrafico_arbol_B_ordenado_por_a_o = new QAction(MainWindow);
        actionGrafico_arbol_B_ordenado_por_a_o->setObjectName("actionGrafico_arbol_B_ordenado_por_a_o");
        actionGrafico_arbol_B_ordenado_por_genero = new QAction(MainWindow);
        actionGrafico_arbol_B_ordenado_por_genero->setObjectName("actionGrafico_arbol_B_ordenado_por_genero");
        ...
        menuGraficas->addAction(actionGrafico_arbol_B_ordenado_por_a_o);
        menuGraficas->addAction(actionGrafico_arbol_B_ordenado_por_genero);
    ...
    void retranslateUi(QMainWindow *MainWindow)
    {
        ...
        actionGrafico_arbol_B_ordenado_por_a_o->setText(QCoreApplication::translate("MainWindow", "Grafico arbol B ordenado por a\303\261o", nullptr));
        actionGrafico_arbol_B_ordenado_por_genero->setText(QCoreApplication::translate("MainWindow", "Grafico arbol B+ ordenado por genero", nullptr));
